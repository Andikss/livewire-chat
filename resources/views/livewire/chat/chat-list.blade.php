                        ...
                        <aside class="grid grid-cols-12 w-full">
                            <a href="/chat/{{ $conversation->id }}"
                                ...
                                <div class="flex gap-x-2 items-center">
                                    ...
                                    @if ($conversation->messages()?->latest()?->first()?->sender_id == auth()->id())
                                ...
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor"
                                                class="bi bi-three-dots-vertical w-5 h-5 text-gary-700"
                                                viewBox="0 0 16 16">
                                                <path
                                    ...
                                    <x-slot name="content">
                                        <div class="w-full">
                                            ...
                                            <button
                                                onclick="confirm('Are you sure?') ||  event.stopImediatePropagation()"
                                                wire:click="deleteByUser('{{ encrypt($conversation->id) }}')"
                                                class="items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5 text-gray-500 hover:bg-gray-100 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-100">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="currentColor" class="bi bi-folder-x"
                                                        viewBox="0 0 16 16">
                                                        <path
